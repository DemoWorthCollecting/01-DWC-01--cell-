...
- (void)setupCollectionView {
    ...
    [colletionView registerClass:[HeroCell class] forCellWithReuseIdentifier:identifier];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BaseView *baseView = [[BaseView alloc] initWithFrame:self.view.bounds];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    for (NSInteger index = 0; index < self.modelArray.count; index++) {
        ...
        HeroCell *cell = (HeroCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
